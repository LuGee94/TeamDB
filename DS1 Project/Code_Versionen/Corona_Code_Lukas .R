...
#-----------<Which variables influence total_death_per_million?> -------------------- 
...
model1<- lm(total_deaths_per_million ~ Physicians_per_1000 + population_density + `Nurses/1000 2019` + `Life-Expectancy 2019` + `Happiness score` + hospital_beds_per_100k + gdp_per_capita)
summary(model1)
